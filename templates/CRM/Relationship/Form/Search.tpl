...
+--------------------------------------------------------------------+
*}
{* Master tpl for Relationship Advanced Search *}
...
<div class="crm-form-block crm-search-form-block">
  ...
  <div class="crm-accordion-wrapper crm-advanced_search_form-accordion {if !empty($ssID) or $rows}collapsed{/if}">
    ...
    <div class="crm-accordion-body">
      {include file="CRM/Relationship/Form/Search/RelationshipCriteria.tpl"}
    </div>
  </div>
</div>
    ...
    <div class="crm-results-block">
      ...
      <div class="crm-search-tasks">
        {if $taskFile}
          ...
          {/if}
        {else}
          {include file="CRM/Relationship/Form/Search/ResultTasks.tpl"}
        {/if}
      </div>
      ...
      <div class="crm-search-results">
        {if $resultFile}
          ...
          {/if}
        {else}
          {include file="CRM/Relationship/Form/Selector.tpl"}
        {/if}
      </div>
